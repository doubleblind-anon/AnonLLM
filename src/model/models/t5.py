...
from src.model.abstract_model import AnonModelHF
...
class T5Rec(AnonModelHF):
    ...
    @classmethod
    def load(cls, dir_path: str, **config_gen_anon_kwargs) -> T5Rec:

        gen_config, config_anon_kwargs = GenerationConfig.from_pretrained(dir_path,
                                                                           **config_gen_anon_kwargs,
    ...
    @classmethod
    def from_cls(cls, model_cls: type[T5Rec], dataset_obj: AnonDataset, **kwargs):
