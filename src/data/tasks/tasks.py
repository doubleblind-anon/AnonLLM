...
class SequentialSideInfoTask(AnonTask):
    templates_dict = {
        0: Template(
...
class DirectSideInfoTask(AnonTask):
    templates_dict = {
        0: Template(
