...
class AnonTask(ABC):
    ...
    str_alias_cls: dict[str, type[AnonTask]] = CaseInsensitiveDict()
    ...
    @classmethod
    @abstractmethod
    def compatible_metrics(cls) -> list[type[AnonMetric]]:
    ...
    @classmethod
    def train(cls):
        AnonTask.training = True

    @classmethod
    def eval(cls):
        AnonTask.training = False
    ...
    def task_exists(cls, task_cls_name: str, template_id: int | str = None,
                    return_bool: bool = True) -> bool | type[AnonTask]:
